...
class Shape {
  ...
  */
  ...
  #createPrimitiveShape(vertexKind, shapeKind, ...vertices) {
    ...
    if (vertexKind === 'bezierVertex') {
      return primitiveShapeCreator(this.#bezierOrder, ...vertices);
    }
    if (vertexKind === 'arcVertex') {
      return primitiveShapeCreator(this.#arcParams, ...vertices);
    }
    return primitiveShapeCreator(...vertices);
  }
